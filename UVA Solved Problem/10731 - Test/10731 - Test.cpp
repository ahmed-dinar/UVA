...
int main(){
 ...
 //   fileout;
    ...
    while( sc1(n)==1 ){
        if(n==0) break;
        while(n--){
            string u,v1,v2,v3,v4,v5;
            cin >> v1 >> v2 >> v3 >> v4 >> v5 >> u;
            g[u[0]].pb(v1[0]);
            g[u[0]].pb(v2[0]);
            g[u[0]].pb(v3[0]);
            g[u[0]].pb(v4[0]);
